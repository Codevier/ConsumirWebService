...
public class MainActivity extends AppCompatActivity implements Asynchtask {
    ...
    public void EnviarPorValley(View view){
        Intent intent = new Intent(MainActivity.this, ValidacionLoginVolley.class);
        EditText txtNombre2 = (EditText)findViewById(R.id.txtName);
        EditText txtContraseña2 = (EditText)findViewById(R.id.txtPassword);
        Bundle b = new Bundle();
        b.putString("NOMBRE", txtNombre2.getText().toString());
    ...
    public void processFinish(String result) throws JSONException {
        ...
        for(int i=0; i< JSONlista.length();i++) {
            ...
            listaBancos=listaBancos+banco.getString("name");
        }
